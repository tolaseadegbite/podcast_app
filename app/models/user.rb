...
class User < ApplicationRecord
  ...
  validates :username, presence: true, uniqueness: { case_sensitive: false }, length: { minimum: 2, maximum: 25 }, format: { with: /\A[a-zA-Z0-9]+(?:[._][a-zA-Z0-9]+)*\z/, message: "username is invalid" }
  ...
  has_many :liked_episodes, through: :likes, source: :likeable, source_type: "Episode"
